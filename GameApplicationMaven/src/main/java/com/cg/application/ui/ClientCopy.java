...
public class ClientCopy {
	 ...
	 * 
	 * SportsRepo repo = new SportsRepoImpl(map); SportsService service = new
	 * SportsServiceImpl(repo);
	 */
	...
	public static void main(String[] args) {
		 ...
		 * GenericXmlApplicationContext("BeanConfig.xml"); SportsService service =
		 * context.getBean("service",SportsService.class);
		 */
